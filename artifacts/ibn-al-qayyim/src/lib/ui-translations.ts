...
const EN_TRANSLATIONS: Record<string, string> = {
  ...
  "حفظ بدون إنترنت": "Save for offline",
  "جارٍ الحفظ…": "Saving…",
  "متاح بدون إنترنت": "Available offline",
  "حذف النسخة المحفوظة": "Remove saved copy",
  ...
  "النتيجة السابقة": "Previous match",
  "النتيجة التالية": "Next match",
  "إغلاق البحث": "Close search",
  "البحث في كل الكتاب": "Search the whole book",
  ...
  "إخفاء الفاصل": "Hide page markers",
  "إظهار الفاصل": "Show page markers",
  "إخفاء الشريط": "Hide toolbar",
  "تحميل القسم التالي": "Load next section",
  ...
  "إضافة عنوان الصفحة أو القسم أو الفصل": "Include page, section, or chapter title",
  "إظهار الموقع": "Show site",
  "تفاصيل الموقع": "Site details",
...
const DE_TRANSLATIONS: Record<string, string> = {
  ...
  "حفظ بدون إنترنت": "Offline speichern",
  "جارٍ الحفظ…": "Wird gespeichert…",
  "متاح بدون إنترنت": "Offline verfügbar",
  "حذف النسخة المحفوظة": "Gespeicherte Kopie löschen",
  ...
  "النتيجة السابقة": "Vorheriger Treffer",
  "النتيجة التالية": "Nächster Treffer",
  "إغلاق البحث": "Suche schließen",
  "البحث في كل الكتاب": "Im ganzen Buch suchen",
  "لا يوجد نص متاح لهذا الفصل بعد.":
  ...
  "إخفاء الفاصل": "Seitenmarkierungen ausblenden",
  "إظهار الفاصل": "Seitenmarkierungen anzeigen",
  "إخفاء الشريط": "Leiste ausblenden",
  "تحميل القسم التالي": "Nächsten Abschnitt laden",
  ...
  عنوان: "Überschrift",
  مطلب: "Unterabschnitt",
  "ابحث في الفهرس": "Index filtern",
  "لا نتائج": "Keine Ergebnisse",
  ...
  "تفاصيل المصدر": "Quellendetails",
  "إضافة عنوان الصفحة أو القسم أو الفصل": "Seite, Abschnitt oder Kapitel einschließen",
  "إظهار الموقع": "Website anzeigen",
  "تفاصيل الموقع": "Websitedetails",
